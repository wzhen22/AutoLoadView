...
NSString *const ktag  = @"TkeyOfTag";

NSString *const kColorRGBGreen = @"TkeyColorRGB_green";
NSString *const kColorRGBRed = @"TkeyColorRGB_red";
NSString *const kColorRGBBlue = @"TkeyColorRGB_blue";
NSString *const kColorRGB_alpha = @"TkeyColor_alpha";

NSString *const kCGRectX = @"TkeyCGRect_x";
NSString *const kCGRectY = @"TkeyCGRect_y";
NSString *const kCGRectWidth = @"TkeyCGRect_width";
NSString *const kCGRectheight = @"TkeyCGRect_height";

NSString *const kTCStyle = @"TkeyTableViewStyle";
NSString *const kIsCustomCell = @"TkeyIsCustomCell";
