...
//表视图的实例化方法
+ (WCustomTableView *)loadTableViewWithModer:(TableOfMapper *)tableOfMapper{
...
//        self.backgroundView = [[UIImageView alloc]initWithImage:[UIImage imageNamed:@"5"]];
        _isCustomCell = NO;
        self.delegate = self;
        self.dataSource = self;
//        if (_isCustomCell) {
//            if (self.style == UITableViewStylePlain) {
//                [self gainFCMDataArray];
//            }else{
//                [self gainFCMDataArrayForGrouped];
//            }
//        }else{
//            if (self.style == UITableViewStylePlain) {
//                [self gainBCMDataArray];
//            }else{
//                [self gainBCMDataArrayForGrouped];
//            }
//        }
